...
function see()
{
alert("PRICE CHANGED SUCCEESSFULLY");
}
</script>
...
<div class="container">
  ...
  <table class="table table-bordered" align="center">
  	<form method="post" action="mess_changeprice_messwala_backend.php">
    <tr>
    ...
    <tr>
    	<td><b><font size="4">NEW PRICE</b></td>
    ...
    <tr>
    	<td></td>
    	<td style="padding-left:90px;"><br><input type="submit" class="scroll" name="submit"  value="CHANGE PRICE" onclick="see()"/></td>
    </tr>
</form>
  </table>
  </div>
